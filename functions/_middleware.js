...
// Runs on EVERY request to your site. If the page being served is a guide page
// (any file matching guide-*.html), it automatically injects the Love/Follow
// widget right before </body> — no manual pasting needed in any guide file ever again.
...
export async function onRequest(context) {
  ...
  // Guides that ALREADY have the widget pasted directly into their own code —
  // skip these so they don't get a duplicate widget injected.
  ...
  // Only touch guide pages — leave everything else (index, resources, admin, etc.) untouched
